...
public interface ResolvedJavaType extends JavaType, ModifiersProvider, AnnotatedElement, Annotated {
    ...
    /**
     * Returns an unmodifiable list of {@code ResolvedJavaRecordComponent} objects representing all the
     * record components of this record class, or {@code null} if this class is
     * not a record class.
     */
    List<? extends ResolvedJavaRecordComponent> getRecordComponents();
